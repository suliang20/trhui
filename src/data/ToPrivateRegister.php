...
/**
 * 注册参数
 * TODO 请求地址：/interface/toPrivateRegister
 * Class ToRegister
 * @package trhui\data
 */
class ToPrivateRegister extends DataBase
{
    public function __construct()
    {
        $this->serverInterface = self::$SERVER_INTERFACE[self::SERVER_TO_PRIVATE_REGISTER];
        $this->serverCode = self::$SERVER_CODE[self::SERVER_TO_PRIVATE_REGISTER];
    }
